...
class SASRecMOBA(BaseModel):
    ...
    def forward(self, batch):
        ...
        v = torch.zeros((B, 1), device=self.args.device)
        ...
        user_embedding += self.role_embedding(batch['roles'])
        ...
        current_user_embedding = torch.gather(user_embedding, 1, turn_idx)
