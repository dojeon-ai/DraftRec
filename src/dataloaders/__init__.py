...
class UserHistoryArray():
    def __init__(self, user_history_array, user_id_to_array_idx, feature_to_array_idx):
        self.user_history_array = user_history_array
        self.user_id_to_array_idx = user_id_to_array_idx
        self.feature_to_array_idx = feature_to_array_idx

    def get_value(self, user_id, user_history_idx, feature):
        user_idx = self.user_id_to_array_idx[user_id]
...
def init_dataloader(args, match_df, user_history_array, user_id_to_array_idx, feature_to_array_idx):
    user_history_dict = UserHistoryArray(user_history_array, user_id_to_array_idx, feature_to_array_idx)
